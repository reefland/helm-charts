...
|------------|------|---------|
| <https://bitnami.com/stack/influxdb> | influxdb | 5.3.5 |
| <https://bitnami.com/stack/mariadb> | mariadb | 11.0.14 |
| <https://bitnami.com/stack/postgresql> | postgresql | 11.6.12 |
...
helm repo update
helm install home-assistant reefland/home-assistant
```
...
helm install home-assistant \
  --set env.TZ="America/New York" \
    reefland/home-assistant
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install home-assistant reefland/home-assistant -f values.yaml
```
